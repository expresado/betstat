...
class BetsControllerTest < ActionController::TestCase
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post :create, bet: { bet: @bet.bet, course: @bet.course, match: @bet.match, result: @bet.result }
    end
  ...
  test "should update bet" do
    patch :update, id: @bet, bet: { bet: @bet.bet, course: @bet.course, match: @bet.match, result: @bet.result }
    assert_redirected_to bet_path(assigns(:bet))
  end
